...
Media Ready requires exhaustive blueprint coverage, approved style, complete animation and terrain contracts, deterministic generated files, compatible licenses and provenance, passing Godot import/runtime tests, current hashes, and an integrated runtime registry.
